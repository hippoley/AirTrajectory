...
class PhysicalWindowEnvironment:
    def __init__(self, driver: PhysicalWindowDriver, opening_id: str, max_sensor_age_s: float = 10.0, require_measured_feedback: bool = False, max_feedback_age_s: float = 10.0):
